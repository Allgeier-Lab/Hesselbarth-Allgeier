...
suppoRt::save_ggplot(plot = gg_combined_cv, filename = paste0("08-noise-cv-", n, extension),
                     path = "04_Figures/", width = height, height = width * 0.7,
                     units = units, dpi = dpi, overwrite = FALSE)

suppoRt::save_ggplot(plot = gg_combined_frac, filename = paste0("08-noise-frac-", n, extension),
