...
# update_starting(parameters = list_parameters, starting = list_starting, 
#                 ag = 1/3, bg = 0.95)
...
input_temp <- meta.arrR::sim_nutr_input(n = n, max_i = max_i, freq_mn = freq_mn,
                                        input_mn = list_stable$nutr_input * 0.5,
...
list_parameters$bg_biomass_min + ((list_parameters$bg_biomass_max - 
list_parameters$bg_biomass_min) * 0.5)
